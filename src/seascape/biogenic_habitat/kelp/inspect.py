"""Inspect kelp composition, proximity, persistence, and survey certainty."""
    ...
    *,
    ...
    return inspect_habitat_surface(
        ...
        metrics=[
            ...
            ("KELP_MAX_LOCAL_FRAC", "Maximum local kelp fraction"),
            ("KELP_DISTANCE_M", "Marine-connected distance to kelp (m)"),
            ("KELP_AREA_WITHIN_5KM_M2", "Kelp area within 5 km (m²)"),
            ("KELP_PERSISTENCE_RATIO", "Kelp persistence ratio"),
            ("KELP_RECENCY_YEARS", "Years since mapped kelp observation"),
        ],
        map_subdirectory=MAP_EXPORT_SUBDIRECTORY,
        map_stem="kelp_habitat",
