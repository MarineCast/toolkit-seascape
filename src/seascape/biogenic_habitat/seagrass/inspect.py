"""Inspect Sentinel-2 seagrass fraction, proximity, and modeled confidence."""
    ...
    *,
    ...
    return inspect_habitat_surface(
        ...
        metrics=[
            ...
            ("SEAGRASS_MAX_LOCAL_FRAC", "Maximum local seagrass fraction"),
            ("SEAGRASS_DISTANCE_M", "Marine-connected distance to mapped seagrass (m)"),
            ("SEAGRASS_AREA_WITHIN_5KM_M2", "Mapped seagrass within 5 km (m2)"),
        ],
        map_subdirectory=MAP_EXPORT_SUBDIRECTORY,
        map_stem="seagrass_habitat",
